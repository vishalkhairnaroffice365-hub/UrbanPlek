...
const LandCard = ({ listing }) => {
  ...
  const displayTitle = title || name || "Untitled Land";
      ...
      <div className="w-full p-4 flex flex-col gap-3 bg-white flex-grow">
        ...
        <div className="pt-3 border-t border-gray-100 mt-auto">
          <p className="text-black text-2xl font-extrabold tracking-tighter">
            ...
            <span className="text-[10px] font-bold text-gray-400 ml-1.5 uppercase tracking-widest">/ Total</span>
          </p>
        </div>
      </div>
    </Link>
...
export default function LandsListings() {
    ...
    <div className="min-h-screen flex flex-col text-[#111318] relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex justify-center py-8 px-4 lg:px-8">
        <div className="flex flex-col max-w-[1100px] w-full">
          ...
          {/* Header Section */}
          <div id="lands" className="flex flex-col gap-8 mb-10 items-start scroll-mt-20">
            <div className="animate-urban-fade-left">
              <h2 className="text-[#111318] text-4xl font-extrabold tracking-tight">Top Land Listings</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {isLoading && listings.length === 0 ? (
              ...
              listings.map((listing) => <LandCard key={listing.db_id} listing={listing} />)
            ) : (
              <div className="col-span-full text-center py-10">
                <p className="text-gray-500 font-medium">No land listings found matching your criteria.</p>
