...
import { BasicDetails, ACCOMMODATION_TYPES } from './BasicDetails';
...
const INITIAL_STUDENT_DATA = {
  ...
  listingType: 'Rent', // Always Rent for students
  price: '',
  location: '',
  sharingType: '',
  area: '',
...
export default function ListStudentAccommodationFormHero() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      formDataToSend.append('type', 'student');
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-light)] font-[var(--font-sans)] text-[#111318]">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-8 space-y-10 pb-32 animate-slide-up pt-24">
        ...
        <section>
          <h1 className="text-3xl font-black tracking-tight mb-2 text-slate-900">List Your Student Accommodation</h1>
          <p className="text-slate-500 text-base font-medium">Reach thousands of verified students in Nashik with a premium listing for PGs, Hostels, and Rooms.</p>
        </section>

        <BasicDetails formData={formData} handleInputChange={handleInputChange} />

        <AccommodationDetails formData={formData} handleInputChange={handleInputChange} />
  ...
  return (
    <div className="fixed inset-0 z-[6000] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200 scale-100">
        <h3 className="text-2xl font-bold mb-6 text-slate-900">Review Accommodation Details</h3>
        ...
        <div className="space-y-6">
          ...
          {data.amenities?.length > 0 && (
            <div className="space-y-3">
              <h4 className="font-bold text-slate-900 border-b border-slate-100 pb-2">Amenities & Services</h4>
