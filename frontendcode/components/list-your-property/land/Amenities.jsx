...
const COMMERCIAL_AMENITIES = [
  { label: 'Power Backup', icon: MdPower },
  { label: 'Lift', icon: MdElevator },
  { label: 'Parking', icon: MdLocalParking },
  { label: 'Security', icon: MdSecurity },
  { label: 'Water Storage', icon: MdWaterDrop },
  { label: 'Fire Safety', icon: MdFireExtinguisher },
  { label: 'Central AC', icon: MdAcUnit },
  { label: 'WIFI/Internet', icon: MdWifi },
  { label: 'Conference Room', icon: MdMeetingRoom },
  { label: 'Cafeteria', icon: MdCoffee },
];
